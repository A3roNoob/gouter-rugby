...
INSERT INTO adulte (nom, prenom, idRang, tel, mail, mdp) VALUES
  ('Horn','Merritt', 3, '0384373435','merritt.horn@neque.net', '31a9d83e188e5c3af82911c2f7b6fd8f'),
  ('Mcguire','Blythe', 2, '0206928802','blythe.mcguire@mit.edu', '9622537551976859729f86d870fde25b'),
  ('Larson','Gannon', 1, '0781811731','test@test.ca', '098f6bcd4621d373cade4e832627b4f6');
...
INSERT INTO enfant (nom,prenom, naissance) VALUES
  ('Horn','Anne', '1998-03-20'),
  ('Horn','Scott', '1998-03-20'),
  ('Mcguire','Cade', '1998-03-20'),
  ('Larson','Kamal', '1998-03-20'),
  ('Larson','Flynn', '1998-03-20'),
  ('Larson','Timon', '1998-03-20'),
  ('Deleon','Mollie', '1998-03-20'),
  ('Herrera','Vielka', '1998-03-20'),
  ('Rhodes','Genevieve', '1998-03-20'),
  ('Burton','Malachi', '1998-03-20'),
  ('Burton','Remedios', '1998-03-20'),
  ('Glenn','Jessamine', '1998-03-20'),
  ('Riddle','Thomas', '1998-03-20'),
  ('Owens','Rigel', '1998-03-20'),
  ('Carson','Craig', '1998-03-20'),
  ('Carson','Ivan', '1998-03-20'),
  ('Bennett','Zenia', '1998-03-20'),
  ('Sampson','Blake', '1998-03-20'),
  ('Sampson','Arden', '1998-03-20'),
  ('Mccoy','Jessamine', '1998-03-20'),
  ('Carey','Erasmus', '1998-03-20'),
  ('Carey','Akeem', '1998-03-20'),
  ('Carey','Dillon', '1998-03-20'),
  ('Malone','Lev', '1998-03-20'),
  ('Malone','Kessie', '1998-03-20'),
  ('Burns','Illiana', '1998-03-20'),
  ('Burns','Jaime', '1998-03-20'),
  ('Burns','Fulton', '1998-03-20'),
  ('Prince','Hoyt', '1998-03-20'),
  ('Stanley','Jack', '1998-03-20');
