...
function resetBase()
{
    ...
    $query3 = $db->prepare("CREATE TABLE consommation(    idConso INT(5) AUTO_INCREMENT,    idEnfant INT(4),    total DECIMAL(6,2),    dateConso DATETIME, CONSTRAINT PK_Consommation PRIMARY KEY (idConso,idEnfant),    CONSTRAINT FK_EnfantConso FOREIGN KEY (idEnfant) REFERENCES enfant(idEnfant));");
